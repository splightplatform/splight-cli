...
class Component:
    ...
    def initialize(self):
        ...
        self._save_startup_file(self._STARTUP_FILEPAHT)
    ...
    def push(self, type, force, public):
        ...
        handler.upload_component(
            type, self.name, self.version, self.parameters, public, self.path
        )
    ...
    @staticmethod
    def _save_startup_file(file_path: str):
        logger.debug("Creating startup file")
        with open(file_path, "w") as fid:
            fid.write("Component is ready for execution")
        logger.debug("Startup file created")
